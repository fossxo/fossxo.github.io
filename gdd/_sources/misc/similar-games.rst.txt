...
..  figure:: ../img/ttt-2004-screen-shot.*
    :alt: Screen shot of the Tic Tac Toe computer game.

    Screen shot of James Richey's 2004 Tic Tac Toe.

James developed his version of while learning the C++ programming language.
Tic-tac-toe provides a fun challenge for learning a new language: it requires
both algorithmic and graphical components to implement a small but nontrivial
application.
